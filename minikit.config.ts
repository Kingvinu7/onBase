...
export const minikitConfig = {
  ...
  miniapp: {
    ...
    screenshotUrls: [`${ROOT_URL}/onBase-hero.png`],
    iconUrl: `${ROOT_URL}/onBase-icon.png`,
    splashImageUrl: `${ROOT_URL}/onBase-splash.png`,
    splashBackgroundColor: "#000000",
    homeUrl: ROOT_URL,
    webhookUrl: `${ROOT_URL}/api/webhook`,
    primaryCategory: "utility",
    tags: ["analytics", "base", "onchain", "wallet", "defi", "explorer"],
    heroImageUrl: `${ROOT_URL}/onBase-hero.png`,
    ...
    ogImageUrl: `${ROOT_URL}/onBase-hero.png`,
  },
} as const;
